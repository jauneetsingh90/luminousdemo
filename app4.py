...
ASTRA_DB_COLLECTION = "luminous_inv"
...
# Ensure the rest of your existing code initializes and uses this updated StreamHandler appropriately.
...
Include an image of the product taken from the image attribute in the metadata and also display the image
...
Include a link from the link metadata field
...
if "messages" not in st.session_state:
    st.session_state.messages = [AIMessage(content="Hi, I'm your Assistant help you with luminous India Products!")]
